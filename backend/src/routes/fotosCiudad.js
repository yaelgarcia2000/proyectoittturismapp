...
router.get("/fotosCiudad", getFotosCiudades);
/**
 * @swagger
 *  /tasks/count:
 *  get:
...
router.get("/fotosCiudad/count", getFotosCiudadCount);
/**
 * @swagger
 *  /tasks:
 *  get:
...
router.get("/fotosCiudad/:id", getFotosCiudad);
/**
 * @swagger
 *  /tasks:
 *  post:
 ...
 */
// crear una tarea
router.post("/fotosCiudad", saveFotosCiudad);
/**
 * @swagger
 *  /tasks:
 *  delete:
...
router.delete("/fotosCiudad/:id", deleteFotosCiudad);
/**
 * @swagger
 *  /tasks:
 *  put:
...
router.put("/fotosCiudad/:id", updateFotosCiudad);
