...
export const DetailsPlaceServiceMarketScreen = ({navigation, route}) => {
  const mercados = route.params;
  console.log(mercados);
  console.log(mercados.imagenRepresentativa);
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: COLORS.white}}>
      <ImageBackground
        style={{flex: 0.7}}
        source={{
          uri: `https://drive.google.com/uc?id=${mercados.ImagenEstable}`,
        }}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{flexDirection: 'row', marginTop: 1}}>
            <MaterialIcons name="local-mall" size={28} color={COLORS.dark} />
            <Text
              style={{
                marginLeft: 5,
                fontSize: 20,
          ...
          <View style={{flexDirection: 'row', alignContent: 'space-between'}}>
            ...
            <View>
              <Text
                ...
                {mercados.CalleDireccion}
                {', '}
                {mercados.NumeroDireccion}
                {', '}
                {mercados.CPDireccion} {'\n'}
                {mercados.ColoniaDireccion}
                {', '}
                {mercados.NombreCiudad}
              </Text>
            </View>
          </View>
          <Text
