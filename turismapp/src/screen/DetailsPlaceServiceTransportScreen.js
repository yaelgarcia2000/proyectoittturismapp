...
export const DetailsPlaceServiceTransportScreen = ({navigation, route}) => {
  const transportes = route.params;
  console.log(transportes);
  console.log(transportes.imagenRepresentativa);
  return (
      ...
      <View style={styles.detailsContainer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{flexDirection: 'row', marginTop: 1}}>
            <MaterialIcons name="commute" size={28} color={COLORS.dark} />
            <Text
              style={{
                marginLeft: 5,
                fontSize: 20,
          ...
          <View style={{flexDirection: 'row', alignContent: 'space-between'}}>
            ...
            <View>
              <Text
                ...
                {transportes.CalleDireccion}
                {', '}
                {transportes.NumeroDireccion}
                {', '}
                {transportes.CPDireccion} {'\n'}
                {transportes.ColoniaDireccion}
                {', '}
                {transportes.NombreCiudad}
              </Text>
            </View>
          </View>
          <Text
