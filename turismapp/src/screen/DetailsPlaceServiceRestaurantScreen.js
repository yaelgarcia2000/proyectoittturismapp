...
export const DetailsPlaceServiceRestaurantScreen = ({navigation, route}) => {
  const restaurantes = route.params;
  console.log(restaurantes);
  console.log(restaurantes.imagenRepresentativa);
  return (
      ...
      <View style={styles.detailsContainer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{flexDirection: 'row', marginTop: 1}}>
            <MaterialIcons name="restaurant" size={28} color={COLORS.dark} />
            <Text
              style={{
                marginLeft: 5,
                fontSize: 20,
          ...
          <View style={{flexDirection: 'row', alignContent: 'space-between'}}>
            ...
            <View>
              <Text
                ...
                {restaurantes.CalleDireccion}
                {', '}
                {restaurantes.NumeroDireccion}
                {', '}
                {restaurantes.CPDireccion} {'\n'}
                {restaurantes.ColoniaDireccion}
                {', '}
                {restaurantes.NombreCiudad}
              </Text>
            </View>
          </View>
          <Text
