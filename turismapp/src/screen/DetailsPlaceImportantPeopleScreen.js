...
export const DetailsPlaceImportantPeopleScreen = ({navigation, route}) => {
  const personajesImportantes = route.params;
  console.log(personajesImportantes);
      ...
      <View style={styles.detailsContainer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{flexDirection: 'row', marginTop: 1}}>
            <MaterialIcons name="person-search" size={28} color={COLORS.dark} />
            <Text
              style={{
                marginLeft: 5,
                fontSize: 20,
          ...
          <Text
            ...
            Aceca de este personaje ilustre:
          </Text>
          <View style={{flexDirection: 'row', alignContent: 'space-between'}}>
            ...
            <View>
              <Text
                ...
                {personajesImportantes.Nacimiento}
              </Text>
            </View>
          </View>
          <View style={{flexDirection: 'row', alignContent: 'space-between'}}>
            ...
            <View>
              <Text
                ...
                {personajesImportantes.Fallecimiento}
              </Text>
            </View>
          </View>
          ...
          <Text
            ...
            {personajesImportantes.Descripcion}
          </Text>
        </ScrollView>
      </View>
